...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/Tap-Payments/CheckoutSDK-iOS.git", :tag => "#{spec.version}" }
  ...
  spec.resources = "CheckoutSDK-iOS/CheckoutSDK-iOS/Core/Assets/**/*.{json,xib,pdf,png,gif}"
