...
@objc public enum TapKeyboardAvoidingMode: Int {
    case maximum
    case minimum
    case minimumDelayed
}

@objc public class TapKeyboardAvoiding: NSObject {
    ...
    public static var keyboardAvoidingMode = TapKeyboardAvoidingMode.minimum
