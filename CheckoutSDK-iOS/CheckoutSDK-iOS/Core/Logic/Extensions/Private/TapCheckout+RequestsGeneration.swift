...
extension TapCheckout {
    ...
    func createConfigRequestModel() -> [String:Any] {
        ...
        let configString = """
{"open":true,"checkoutMode":"page","paymentType":"ALL","supportedPaymentMethods":"ALL","selectedCurrency":"KWD","supportedCurrencies":"ALL","gateway":{"publicKey":"pk_test_Vlk842B1EA7tDN5QbrfGjYzh","merchantId":""},"customer":{"id":"cus_TS01A5720231124Hj132604096","firstName":"Ahmed","lastName":"Sharkawy","email":"example@gmail.com","phone":{"countryCode":"20","number":"1099137773"}},"transaction":{"mode":"charge","charge":{"saveCard":true,"auto":{"type":"VOID","time":100},"redirect":{"url":"https://demo.dev.tap.company/v2/sdk/checkout"},"threeDSecure":true}},"amount":0.1,"order":{"items":[{"amount":0.1,"currency":"KWD","name":"Item Title 1","quantity":1,"description":"item description 1"}]},"cardOptions":{"showBrands":true,"showLoadingState":false,"collectHolderName":true,"preLoadCardName":"","cardNameEditable":true,"cardFundingSource":"all","saveCardOption":"all","forceLtr":false}}
"""
