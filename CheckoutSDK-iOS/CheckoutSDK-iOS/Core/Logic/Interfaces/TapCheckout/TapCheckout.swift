...
@objc public class TapCheckout: NSObject {
    ...
    @objc public static var displayMonoLight:Bool = false {
        didSet{
            TapThemeManager.showMonoForLightMode = displayMonoLight
        }
    }
    /// Indicates whether to display the dark colored or dark icons in the dark theme mode
    @objc public static var displayColoredDark:Bool = false {
        didSet{
            TapThemeManager.showColoredForDarkMode = displayColoredDark
        }
    }
