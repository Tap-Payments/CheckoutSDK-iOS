...
internal class SwiftyBeaver {

    /// version string of framework
    static let version = "1.9.4"  // UPDATE ON RELEASE!
    /// build number of framework
    static let build = 1950 // version 1.6.2 -> 1620, UPDATE ON RELEASE!
    ...
    private(set) static var destinations = Set<BaseDestination>()

    // MARK: Destination Handling

    /// returns boolean about success
    @discardableResult
    class func addDestination(_ destination: BaseDestination) -> Bool {
    ...
    /// returns boolean about success
    @discardableResult
    class func removeDestination(_ destination: BaseDestination) -> Bool {
    ...
    class func removeAllDestinations() {
        destinations.removeAll()
    }

    /// returns the amount of destinations
    class func countDestinations() -> Int {
    ...
    class func custom(level: SwiftyBeaver.Level, message: @autoclosure () -> Any,
     ...
     */
    class func flush(secondTimeout: Int64) -> Bool {
