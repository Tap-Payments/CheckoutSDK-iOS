...
internal protocol FilterType : AnyObject {
...
internal class Filters {
    static let Path = PathFilterFactory.self
    static let Function = FunctionFilterFactory.self
    static let Message = MessageFilterFactory.self
}
...
internal class Filter {
    ...
    init(_ target: Filter.TargetType, required: Bool, minLevel: SwiftyBeaver.Level) {
        self.targetType = target
        self.required = required
        self.minLevel = minLevel
    }

    internal func getTarget() -> Filter.TargetType {
        return self.targetType
    }

    internal func isRequired() -> Bool {
        return self.required
    }

    internal func isExcluded() -> Bool {
        return false
    }

    /// returns true of set minLevel is >= as given level
    internal func reachedMinLevel(_ level: SwiftyBeaver.Level) -> Bool {
...
/// case sensitive.
internal class CompareFilter: Filter, FilterType {

    private var filterComparisonType: Filter.ComparisonType?

    override init(_ target: Filter.TargetType, required: Bool, minLevel: SwiftyBeaver.Level) {
    ...
    internal func apply(_ value: String?) -> Bool {
    ...
    override internal func isExcluded() -> Bool {
...
internal class FunctionFilterFactory {
    static func startsWith(_ prefixes: String..., caseSensitive: Bool = false,
...
internal class MessageFilterFactory {
    static func startsWith(_ prefixes: String..., caseSensitive: Bool = false,
                                  required: Bool = false, minLevel: SwiftyBeaver.Level = .verbose) -> FilterType {
...
internal class PathFilterFactory {
    static func startsWith(_ prefixes: String..., caseSensitive: Bool = false,
                                  required: Bool = false, minLevel: SwiftyBeaver.Level = .verbose) -> FilterType {
...
internal func == (lhs: Filter.TargetType, rhs: Filter.TargetType) -> Bool {
    switch (lhs, rhs) {
