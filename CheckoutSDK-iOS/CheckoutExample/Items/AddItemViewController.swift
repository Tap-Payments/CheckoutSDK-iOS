...
class AddItemViewController: FormViewController {
    ...
    @objc func saveTapped(){
        ...
        let item = ItemModel(title: titleVal, description: descriptionVal, price: priceVal, quantity: quantityVal, discount: AmountModificatorModel(type: .Fixed, value: discountVal),totalAmount: 0)
